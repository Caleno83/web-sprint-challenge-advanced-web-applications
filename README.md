...
tokens or JWTs (JAson Web Tokens) are used by modern web services to authenticate a user with them. After the user is authenticated with tokens, they can see our app or sensitive data in the web browser.

2. What steps can you take in your web apps to keep your data secure?

we can used protected routes using an authentication token, and using axiosWithAuth so we can work with data with a protected endpoint.

3. Describe how web servers work.

The way that web servers work is first when web browsers locate a specific server computer though a URL and domain name, and will get information from that server.  Sometimes the information that the server has code or programs that can render information or data to the web browser.
